...
struct sequential_container_mapper<eastl::vector<T, A>> : detail::sequential_container_base_dynamic_direct_access<eastl::vector<T, A>> {};

template<typename T, size_t N, bool O>
struct sequential_container_mapper<eastl::fixed_vector<T, N, O>> : detail::sequential_container_base_dynamic_direct_access<eastl::fixed_vector<T, N, O>> {};

template<typename T>
struct sequential_container_mapper<eastl::list<T>> : detail::sequential_container_base_dynamic_itr_access<eastl::list<T>> {};

template<typename T>
struct sequential_container_mapper<eastl::deque<T>> : detail::sequential_container_base_dynamic_direct_access<eastl::deque<T>> {};

template<typename T, size_t N>
struct sequential_container_mapper<eastl::array<T, N>> : detail::sequential_container_base_static<eastl::array<T, N>> {};
...
namespace detail
{
	...
	struct iterator_wrapper_base<eastl::hashtable_iterator<Value, bConst, bCacheHashCode>> : eastl_iterator_wrapper_base<eastl::hashtable_iterator<Value, bConst, bCacheHashCode>> {};

	//----------------------------------------------------------------------------------------------------------------------
	template<typename T, typename Pointer, typename Reference>
	struct iterator_wrapper_base<eastl::rbtree_iterator<T, Pointer, Reference>> : eastl_iterator_wrapper_base< eastl::rbtree_iterator<T, Pointer, Reference>> {};
...
struct associative_container_mapper<eastl::unordered_map<K, T>> : detail::eastl_associative_container_base<eastl::unordered_map<K, T>> {};

template<typename K, typename T>
struct associative_container_mapper<eastl::map<K, T>> : detail::eastl_associative_container_base<eastl::map<K, T>> {};

template<typename K, typename T, typename Compare>
struct associative_container_mapper<eastl::vector_map<K, T, Compare>> : detail::eastl_associative_container_base<eastl::vector_map<K, T, Compare>> {};

template<typename T>
struct associative_container_mapper<eastl::set<T>> : detail::eastl_associative_container_key_base<eastl::set<T>> {};

template <typename T, typename Compare>
struct associative_container_mapper<eastl::set<T, Compare>> : detail::eastl_associative_container_key_base<eastl::set<T, Compare>> {};

template<typename K>
struct associative_container_mapper<eastl::vector_set<K>> : detail::eastl_associative_container_key_base<eastl::vector_set<K>> {};

namespace detail
{
	template<template <typename, size_t, bool, typename > class T, typename T1, size_t N1, bool N2, typename T2>
	struct template_type_trait<T<T1, N1, N2, T2>> : std::true_type
	{
		static std::vector<::rttr::template_argument_data> get_template_arguments()
		{
			return {
				::rttr::template_argument_data{::rttr::type::get<T1>(), true},
				::rttr::template_argument_data{::rttr::type::get<decltype(N1)>(), false},
				::rttr::template_argument_data{::rttr::type::get<decltype(N2)>(), false},
